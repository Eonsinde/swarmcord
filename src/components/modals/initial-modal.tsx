...
const InitialModal = () => {
    ...
    return (
        <Dialog open>
            <DialogContent
                className="relative h-full md:h-auto max-w-full md:max-w-[425px] p-0 transition-height duration-500 overflow-hidden"
                style={{
                    height: menuHeight
                }}
                showCloseBtn={false}
                    ...
                    <div className="create-server-menu w-full">
                        <div className="p-5 pb-0">
                            <DialogHeader className="pb-4">
                                ...
                                <DialogDescription>
                                    Your server is where you and friends chit-chat. Make yours and start conversing
                                </DialogDescription>
                            </DialogHeader>
